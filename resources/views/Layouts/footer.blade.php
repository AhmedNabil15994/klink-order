          ...
          <div class="col-md-3 col-sm-4">
            <div class="footer__info">
              <div class="footer-logo">
                <img src="{{asset('/assets/images/logoFooter.png')}}" alt="mylogo" draggable="false">
              </div>
              ...
              <div class="row">
                <div class="social">
                  ...
                  <ul class="social__list clearfix" style="display:flex;flex-wrap:wrap;align-items:center;">
                    ...
                    <li class="social__list--item2 ">
                      <img class="custom-margin" src="{{asset('/assets/images/pay.png')}}" alt="pay">
                    </li>
                    <li class="social__list--item2">
                      <img src="{{asset('/assets/images/paypal.svg')}}" alt="paypal">
                    </li>
                    <li class="social__list--item2">
                      <img class="" src="{{asset('/assets/images/sepa.svg')}}" alt="paypal">
                    </li>
                    <li class="social__list--item2">
                      <img class="" src="{{asset('/assets/images/vorkasse.svg')}}" alt="paypal" style="height: 35px;margin-top: 0 !important;">
                    </li>
                  </ul>
                </div><!--social-->
              </div>
...
<script src="{{ asset('assets/production/js/swiper.min.js') }}"></script>
<script src="{{ asset('assets/production/js/roundslider.js') }}"></script>
<script src="{{ asset('assets/vendors/iCheck/icheck.min.js') }}"></script>
<script src="{{ asset('assets/vendors/moment.js') }}"></script>
<script src="{{ asset('assets/vendors/bootstrap/js/transition.js') }}"></script>
<script src="{{ asset('assets/vendors/bootstrap/js/collapse.js') }}"></script>
